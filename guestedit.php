...
<tr>
	...
	<tr>
		...
		<div class = 'fast_link'>
		<?PHP
		$nowL = array('首頁' => 'index.php', '修改會員資料' => 'guesetedit.php');
	...
	<tr>
		...
		<tr>
			...
			{
				case '1':
					$userHealth = get_guest_health($USER['health_id']);
					echo "<div class = 'title3' style = 'padding-left:100px;padding-top:1px;'>修改個人資料</div>\n";
					echo "<form id = 'form2' name = 'form2' method = 'post' action = 'guestedit.php'>\n";
				...
				case '2':				
					$userHealth = get_guest_health($_POST['health_id']);
					...
					echo "<form id = 'form1' name = 'form1' method = 'post' action = 'guestedit.php'>\n";
					...
					echo "</tr>\n";
					echo "<tr>\n";
					echo "	<td align = 'right'><span class = 'style5'>‧輕度：</span></td>\n";
					echo "	<td>除了因通車、購物等約1小時的步行和輕度手工或家事等站立之外，大部分從事坐著的工作、讀書、談話等情況。</td>\n";
					echo "</tr>\n";
					echo "<tr>\n";
					echo "	<td align = 'right'><span class = 'style6 style7'>‧中度：</span></td>\n";
					echo "	<td>除了因通車、購物等其他事項約2小時的步行和從事坐著的工作、辦公、讀書、談話等之外，還從事機械操作、接待或家事等站立較多之活動。</td>\n";
					echo "</tr>\n";
					echo "<tr>\n";
					echo "	<td align = 'right'><span class = 'style4'>‧重度：</span></td>\n";
