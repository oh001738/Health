...
<tr>
	...
	<tr>
		...
		<div class = 'fast_link'>
		<?PHP
		$nowL = array('首頁' => 'index.php', '修改會員資料' => 'useredit.php');
	...
	<tr>
		...
		<tr>
			...
			{
				case '1':
					echo "<div class = 'title3' style = 'padding-left:10px;padding-top:1px;'>修改個人資料</div>\n";
					...
					echo "<td><input type = 'text' name = 'c_name' id = 'c_name' value = '" . $userValue['c_name'] . "'></td>\n";
					echo "</tr>\n";
					echo "<tr>\n";
					echo "	<td align = 'right'>英文名字：</td>\n";
					echo "	<td><input name = 'e_name' id = 'e_name' type = 'text' size = '15'  value = '" . $userValue['e_name'] . "'></td>\n";
					echo "</tr>\n";
					echo "<tr>\n";
					echo "	<td align = 'right'>電子郵件：</td>\n";
					echo "	<td><input name= 'email' id= 'email' type= 'text' size= '30'  value = '" . $userValue['email'] . "'></td>\n";
					echo "</tr>\n";
					echo "<tr>\n";
					echo "	<td colspan = '2'><div style = 'padding-left:150px;padding-top:20px'>登入帳號密碼</div></td>\n";
					echo "</tr>\n";
					echo "<tr>\n";
					echo "	<td align = 'right'>帳號：</td>\n";
					echo "	<td>" . $userValue['username'] . "</td>\n";
					echo "</tr>\n";
					echo "<tr>\n";
					echo "	<td align = 'right'>修改密碼：</td>\n";
					echo "	<td><input name= 'password_1' id= 'password_1' type= 'password' size= '20'></td>\n";
					echo "</tr>\n";
					echo "<tr>\n";
					echo "	<td align = 'right'>確認密碼：</td>\n";
					echo "	<td><input name= 'password_2' id= 'password_2' type= 'password' size= '20'></td>\n";
					echo "</tr>\n";
					echo "<tr>\n";
					...
					echo "	<td><input name= 'telphone' id= 'telphone' type= 'text' size= '15' value = '" . $userValue['telphone'] . "'></td>\n";
					echo "</tr>\n";
					echo "<tr>\n";
					echo "	<td align = 'right'>行動電話：</td>\n";
					echo "	<td><input name= 'celphone' id= 'celphone' type= 'text' size= '15' value = '" . $userValue['celphone'] . "'></td>\n";
					echo "</tr>\n";
					echo "<tr>\n";
					echo "	<td align = 'right'>地址：</td>\n";
					echo "	<td><input name= 'address' id= 'address' type= 'text' style = 'width:100%' value = '" . $userValue['address'] . "'></td>\n";
					echo "</tr>\n";
					...
					echo"<td>
						...
						<option value = '0' ".($userValue['location']==0?'selected':'select').">請選擇</option>
                        <option value = '1' ".($userValue['location']==1?'selected':'select').">台北</option>
                        <option value = '2' ".($userValue['location']==2?'selected':'select').">台中</option>
                        <option value = '3' ".($userValue['location']==3?'selected':'select').">高雄</option>
						</select> </td>";
					echo "</tr>\n";
					...
					echo "	<input type= 'button' name= 'ok' id= 'ok' value= '確定' onclick = 'check_form();'></div></td>\n";
					echo "</tr>\n";
					echo "</table>\n";
					echo "</form> \n";
					break;
				...
				case '2':
					...
					if ( ($_POST['step'] == '2' && trim($_POST['userid']) != '') || $_GET['type'] == 'edit' )
					{
						if ( $_GET['type'] == '' )
						{
							$sql = "UPDATE user SET ";
							$sql .= "c_name = '" . trim($_POST['c_name']) . "' , ";
							$sql .= "e_name = '" . trim($_POST['e_name']) . "' , ";
							$sql .= "email = '" . trim($_POST['email']) . "' , ";
							if ( trim($_POST['password_1']) != '' && trim($_POST['password_1']) == trim($_POST['password_2']) )
							{
								$sql .= "password = '" . md5(trim($_POST['password_1'])) . "' , ";
							}
							$sql .= "telphone = '" . trim($_POST['telphone']) . "' , ";
							$sql .= "celphone = '" . trim($_POST['celphone']) . "' , ";
							$sql .= "address = '" . trim($_POST['address']) . "' , ";
							$sql .= "location = '" . trim($_POST['location']) . "' , ";
							$sql .= "up_time = '" . time() . "' ";
							$sql .= "WHERE id = '" . trim($_POST['userid']) . "'";
						}
						if ( mysql_query($sql) || $_GET['type'] == 'edit' )
						{
							$userHealth = get_user_health($USER['userid']);
							echo "<div class = 'title3' style = 'padding-left:100px;padding-top:1px;'>修改個人資料</div>\n";
							echo "<form id = 'form2' name = 'form2' method = 'post' action = 'useredit.php'>\n";
							...
							echo "</tr>\n";
							echo "<tr>\n";
							echo "	<td colspan = '2'>您的身體質量指數 (BMI) 為 <input name= 'bmi' type= 'text' id= 'bmi' size= '4' READONLY></td>\n";
							echo "</tr>\n";
							echo "<tr>\n";
							echo "	<td id = 'msg' name = 'msg' colspan = '2'></td>\n";
							echo "</tr>\n";
							echo "<tr>\n";
							echo "	<td colspan = '2'>您的理想體重為 <input name= 'good_w' type= 'text' id= 'good_w' size= '3' readonly> ~ <input name= 'good_w2' type= 'text' id= '
2' size= '3' readonly></td>\n";
							echo "</tr>\n";
							echo "<tr>\n";
							echo "	<td>腰圍</span></td>\n";
							echo "	<td>\n";
							...
							showMsg('發生錯誤，請洽系統管理員!!');
							reDirect(ROOT_URL . '/useredit.php');
						}
					}
					break;
				...
				case '4':
					...
					foreach ( $hidden as $key => $value )
					{
						if ($key == 'step')
						{
							echo "<input type = 'hidden' id = '" . $key . "' name = '" . $key . "' value = '5'>\n";
						}else{
							echo "<input type = 'hidden' id = '" . $key . "' name = '" . $key . "' value = '" . $value . "'>\n";
						}
					}
				...
				case '5':
					if ( trim($_POST['userid']) != '' && trim($_POST['healthid']) != '' )
					{
						...
						//計算腎絲球過濾率GFR
						if ( trim($_POST['creatinine']) != '' || trim($_POST['creatinine']) != 0)
						{	//計算年紀
						...
						echo "</tr>\n";
						echo "<tr>\n";
						echo "  <td align = 'right' colspan = '2'><input name = 'ok' type = 'button' id = 'ok' onclick = \"location.href('" . ROOT_URL . "/index.php')\" value = '完成'></td>\n";
						echo "</tr>\n";
						echo "</table>\n";
					}
					break;
...
{
	var Obj = document.form1;
	if(trim(Obj.password_1.value) != '')
	{
		if ( Obj.password_1.value != Obj.password_2.value )
		{
			alert('二次密碼輸入不一致!!');
			Obj.password_1.focus();
		}
