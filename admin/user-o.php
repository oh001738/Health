...
{
    //新增user資料庫語法
    $inSQL = "INSERT INTO user (c_name, e_name, email, username, `password`, telphone, celphone, address, add_time, up_time)VALUES(";
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
    ...
    echo "  <span style = 'padding-left:20px'><input type = 'button' id = 'update' name = 'update' value = '儲存' onclick = 'javascript:check()'></span>\n";
    echo "  </td>\n";
    echo "</tr>\n";
    if ($_GET['action'] == 'edit')
    {
...
else if ( $op == 'user' )
{
	...
	if($USER['power'] == '1')
	 {
		 echo "  <input type = 'button' id = 'adduser' name = 'adduser' value = '新增會員' onclick = 'location.href=\"admin.php?op=user&action=add&back=" . base64_encode(getenv("REQUEST_URI")) . "\"'></td>\n";
	 }
