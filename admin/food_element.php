...
if ( $op == 'food_element' && ( $_GET['action'] == 'edit' || $_GET['action'] == 'add' ) )
{
	...
	if ($_GET['action'] == 'edit' && trim($row['img']) != '')
	{
		...
		echo "  <br><a href = '" . ROOT_URL . "/admin/admin.php?op=" . $op . "&action=delimg&id=" . $_GET['id'] . "&back=" . $_GET['back'] . "&img=" . base64_encode($row['img']) . "&getback=" . base64_encode(getenv("REQUEST_URI")) . "' onclick = 'return confirm(\"確定要刪除嗎?\")'>刪除圖片</a><br>\n";
	}
...
-->
	...
	/**
		echo "<table border = '0' cellpadding = '4' cellspacing = '1' width = '95%' valign = 'top'>\n";
  	 	echo "<form action = '" . ROOT_URL . "/admin/admin.php?op=food_element' id = 'searchform' name = 'searchform' method = 'post'>\n";
	    echo "<tr>\n";
	    ...
	    echo "  <input type = 'button' id = 'add' name = 'add' value = '新增食材' onclick = 'location.href=\"admin.php?op=".$op."&action=add&back=" . base64_encode(getenv("REQUEST_URI")) . "\"'></td>\n";
 	    echo "</tr>\n";
    	echo "</form>\n";
	    echo "</table>\n";
	**/
    ...
    <?php
		...
		{
		echo "  <td><div style = 'width:110px'><div class = 'title'>檢視食材資料</div></div></td>\n";		
		}
	    echo "  <td align = 'right'>\n";
	    echo "  <select id = 'type' name = 'type'>\n";
    	echo "     <option value = 'name'>名稱</option>\n";
		...
		if($USER['power'] == '1' ||$USER['power'] == '3')
		{
			echo "  <input type = 'button' id = 'adduser' name = 'adduser' value = '新增食材' onclick = 'location.href=\"admin.php?op=food_element&action=add&back=" . base64_encode(getenv("REQUEST_URI")) . "\"'></td>\n";
		}
	...
	<table border = '1' cellpadding = '2' cellspacing = '1' width = '100%' style = 'border-collapse:collapse' bordercolor = '#FFE375'>
	<tr bgcolor = '#EEEEEE'>
		<td align = 'center' bgcolor="#FFCC00" class = 'text13px style2'>名稱</td>
		<td align = 'center' bgcolor="#FFCC00" class = 'text13px style2'>重量</td>
		<td align = 'center' bgcolor="#FFCC00" class = 'text13px style2'>熱量</td>
		<td align = 'center' bgcolor="#FFCC00" class = 'text13px style2'>膽固醇</td>
		<td align = 'center' bgcolor="#FFCC00" class = 'text13px style2'>脂肪</td>
		<td align = 'center' bgcolor="#FFCC00" class = 'text13px style2'>蛋白質</td>
		<td align = 'center' bgcolor="#FFCC00" class = 'text13px style2'>醣類</td>
		<td align = 'center' bgcolor="#FFCC00" class = 'text13px style2'>鉀</td>
		<td align = 'center' bgcolor="#FFCC00" class = 'text13px style2'>鈉</td>
		<td align = 'center' bgcolor="#FFCC00" class = 'text13px style2'>鈣</td>
		<td align = 'center' bgcolor="#FFCC00" class = 'text13px style2'>磷</td>
		<td align = 'center' bgcolor="#FFCC00" class = 'text13px style2'>鎂</td>
        
 <?php  if($USER['power'] == '1' || $USER['power'] == '3') 
 		{ ?>
			<td align = 'center' bgcolor="#FFCC00" class = 'text13px style2'>修改</td>
			<td align = 'center' bgcolor="#FFCC00" class = 'text13px style2'>刪除</td>
         <?php
         }
	...
	while( $row = mysql_fetch_array($result) )
	{
		...
		echo "	<td align = 'center' class = 'text13px'>" . $row['name'] . "</td>\n";
		echo "	<td align = 'center' class = 'text13px'>" . $row['kg'] . " g</td>\n";
		echo "	<td align = 'center' class = 'text13px'>" . $row['k'] . "</td>\n";
		echo "	<td align = 'center' class = 'text13px'>" . $row['cholesterol'] . "</td>\n";
		echo "	<td align = 'center' class = 'text13px'>" . $row['fat'] . "</td>\n";
		echo "	<td align = 'center' class = 'text13px'>" . $row['e'] . "</td>\n";
		echo "	<td align = 'center' class = 'text13px'>" . $row['carbohydrate'] . "</td>\n";
		echo "	<td align = 'center' class = 'text13px'>" . $row['potassium'] . "</td>\n";
		echo "	<td align = 'center' class = 'text13px'>" . $row['sodium'] . "</td>\n";
		echo "	<td align = 'center' class = 'text13px'>" . $row['calcium'] . "</td>\n";
		echo "	<td align = 'center' class = 'text13px'>" . $row['phosphorous'] . "</td>\n";
		echo "	<td align = 'center' class = 'text13px'>" . $row['mg'] . "</td>\n";
		if($USER['power'] == '1' ||$USER['power'] == '3')
		{
		...
		echo "	<td align = 'center' class = 'text13px'><a href = 'admin.php?op=" . $op . "&action=delete&id=" . $row['id'] . "&img=" . base64_encode($row['img']) . "' onclick = 'return confirm(\"確定要刪除嗎?\")'>刪除</a></td>\n";
		}
		elseif($USER['power'] == '2')
		{
			echo "	<td align = 'center' class = 'text13px'><a href = 'admin.php?op=" . $op . "&action=seepic&id=" . $row['id'] . "&back=" . base64_encode(getenv("REQUEST_URI")) . "'>檢視</td>\n";
		}
		echo "</tr>\n";
		$i++;
	}
