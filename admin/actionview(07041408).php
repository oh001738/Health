...
if ( $op == 'actionview' )
{
	...
	echo "	<tr>\n";
	echo "		<td width = '23%'><div style = 'width:170px'><div class = 'title'>檢視行為記錄</div></div></td>\n";
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	  	echo "  <td align = 'right'>\n";
	    ...
	    echo "  <input type = 'submit' id = 'search' name = 'search' value = '查詢'>\n";
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	echo "	</tr>\n";
	echo "	</form>\n";
	echo "	</table>\n";
	...
	echo "		<td width=20% class = 'text13px' align = 'center'>時間</td>\n";
	...
	{
		//$act_total = countSQL('action_log', 'id', "WHERE username LIKE '%" . trim($_POST['keyword']) . "%' OR actid LIKE '%" . trim($_POST['keyword']) . "%'");   //計算搜尋總數數
		$act_total = countSQL('action_log', 'id', $sqlwhe);
	}else{
		$act_total = countSQL('action_log', 'id');   //計算所有會員總數
	}
	
    $page = ($_GET['page'])? $_GET['page'] : 0;   //設定目前頁數
    $total_page = ceil($act_total / PAGE_NUM);   //計算總共頁數
	...
	echo "總數:".$act_total." 頁數:".$page." 總頁:".$total_page;
	?>
