		...
		defaultOptions.ui.errorMessages = {
			wordLength: "您的密碼太短了",
			wordNotEmail: "請不要使用電子信箱做為您的密碼",
			wordSimilarToUsername: "請不要使用帳號名稱做為您的密碼",
			wordTwoCharacterClasses: "Use different character classes",
			wordRepetitions: "太多重複",
			wordSequences: "您的密碼規則過於簡單"
		};
		defaultOptions.ui.verdicts = ["弱", "偏低", "標準", "安全", "堅不可摧"];
