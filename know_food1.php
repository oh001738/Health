...
$query_Recordset1 = sprintf("SELECT * FROM choose_food WHERE ch_kind = %s", GetSQLValueString($colname_Recordset1, "text"));
   ...
   ?>
        <td><table width="200" border="0">
            <tr>
              ...
              <td><span class="style5">名字：<?php echo $row_Recordset1['ch_name']; ?>一份</span><br />
                    <span class="style6">熱量：<?php echo $row_Recordset1['ch_k']; ?>Kcal<br />
                      脂肪：<?php echo $row_Recordset1['ch_fat']; ?>mg<br />
                      蛋白質：<?php echo $row_Recordset1['ch_e']; ?>mg</span></td>
            </tr>
            <tr>
              <td bordercolor="#000000"><input name="checkbox" type="checkbox" id="選取" onclick="MM_popupMsg('<?php echo  \"1234\"; ?>選項')" value="checkbox" />
              </td>
              <td>&nbsp;</td>
            </tr>
        </table></td>
...
echo("</tr>");
    ...
    <?php if ($pageNum_Recordset1 < $totalPages_Recordset1) { // Show if not last page ?>
        <div align="right"><a href="<?php printf("%s?pageNum_Recordset1=%d%s", $currentPage, min($totalPages_Recordset1, $pageNum_Recordset1 + 1), $queryString_Recordset1); ?>">下一頁</a>
          </div>
